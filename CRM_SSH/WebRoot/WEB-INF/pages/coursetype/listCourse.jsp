...
<table width="97%" border="1" >
  ...
  <s:iterator value="#pageBean.data" status="vs">
   <tr class="<s:property value="#vs.even ? 'tabtd2' :'tabtd1'"/>" >
	    <td align="center"><s:property value="courseName"></s:property> </td>
	    <td align="center"><s:property value="remark"></s:property> </td>
	    <td align="center"><s:property value="total"></s:property></td>
	    <td align="center"><s:property value="courseCost"></s:property></td>
