...
public class Exercise10_12 {
  public static void main(String[] args) {
    Triangle2D r1 = new Triangle2D(2.5, 2, 4.2, 3, 5, 3.5);
    System.out.println("Area is " + r1.getArea());
    System.out.println("Perimeter is " + r1.getPerimeter());
    System.out.println(r1.contains(3, 3));
    System.out.println(r1.contains(new Triangle2D(2.9, 2, 4, 1, 1, 3.4)));
    System.out.println(r1.overlaps(new Triangle2D(2, 5.5, 4, -3, 2, 6.5)));
  }
}
class MyPoint{
	private double x,y;
